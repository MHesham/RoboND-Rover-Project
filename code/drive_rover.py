...
class RoverState():
    def __init__(self):
        ...
        self.prev_sample_time = None # Last time we sampled the velocity and yaw
        self.prev_vel = None # Last sampled velocity
        self.prev_yaw = None # Last sampled yaw
        ...
        self.go_forward = 2500  # Threshold to go forward again
        ...
        self.is_vel_stuck = False
        self.is_steer_stuck = False
        self.visited = np.zeros_like(ground_truth, dtype=np.int)
        self.minimap_size = 2
